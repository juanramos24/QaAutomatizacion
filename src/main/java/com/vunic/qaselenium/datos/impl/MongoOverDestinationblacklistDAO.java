...
public class MongoOverDestinationblacklistDAO implements IMongoOverDestinationblacklistDAO
{
	...
	*/
	...
	{	
		...
		String sql = "INSERT INTO mongo_over_destinationblacklist (ID,destinationBlackList) VALUES (?,?)";
		PreparedStatement pst_1 = servicio.getPreparedStatement(sql);
		
		for (MongoOverDestinationblacklistDTO dto : dtos)
		{
			
			pst_1.setInt(1,dto.getId());
			pst_1.setString(2,dto.getDestinationBlackList());
	...
	public void deleteFull() throws  SQLException
	{
		...
		String sql = "DELETE FROM mongo_over_destinationblacklist ";
		PreparedStatement pst_1 = servicio.getPreparedStatement(sql);
