...
public class MongoOverPassengertypelistDAO implements IMongoOverPassengertypelistDAO
{
	/**
	...
	*/
	...
	{	
		...
		String sql = "INSERT INTO mongo_over_passengertypelist (ID,passengerTypeList) VALUES (?,?)";
		
		PreparedStatement pst_1 = servicio.getPreparedStatement(sql);
		
		for (MongoOverPassengertypelistDTO dto : dtos)
		{
			
			pst_1.setInt(1,dto.getId());
			pst_1.setString(2,dto.getPassengerTypeList());
	...
	public void deleteFull() throws  SQLException
	{
		...
		String sql = "DELETE FROM mongo_over_passengertypelist ";
